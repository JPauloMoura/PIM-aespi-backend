...
class UsersBusiness {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!passwordIsCorrect)
                    throw new CustomErrors_1.CustomError(403, "Invalid credentials");
    ...
    changeDoneStatus(token) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (!token)
                    throw new CustomErrors_1.CustomError(400, "Invalid token");
                const user = Authenticator_1.default.getTokenData(token);
                if (!(user.id))
                    throw new CustomErrors_1.CustomError(400, "Invalid Token");
                yield UsersDataBase_1.usersDataBase.changeDoneStatus(user.id);
            }
            catch (error) {
